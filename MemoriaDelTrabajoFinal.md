...
- [**Introducción general**](#-introduccion-general)
  - [1.1 Análisis de necesidad y objetivos](#11-analisis-de-necesidad-y-objetivos)
  - [1.2 Descripción general del sistema](#12-descripcion-general-del-sistema)
- [**Introducción específica**](#-introduccion-especifica) 
  - [2.1 Requisitos](#21-requisitos)
  - [2.2 Casos de uso](#22-casos-de-uso)
  - [2.3 Descripción de los módulos del sistema](#23-descripcion-de-los-modulos-del-sistema)
    - [2.3.1 Alimentación](#231-alimentacion)
    - [2.3.2 Microcontrolador](#232-microcontrolador)
    - [2.3.3 Módulo del micrófono](#233-modulo-de-microfono)
    - [2.3.4 Módulo _Bluetooth_](#234-modulo-bluetooth)
    - [2.3.5 Módulo _buzzer_](#235-modulo-buzzer)
    - [2.3.6 Interfaz de usuario: _DIP switch_ y _LEDs_](#236-interfaz-de-usuario-dip-switch-y-leds)
  - [**Diseño e implementación**](#diseño-e-implementacion)
    - [3.1 Arquitectira general](#31-arquitectura-general)
    - [3.2 Diseño de _hardware_](#32-diseño-de-hardware).
      - [3.2.1 Conexión del módulo del micrófono](#321-conexion-del-modulo-del-microfono)
      - [3.2.2 Conexión del módulo _Bluetooth_](#321-conexion-del-modulo-bluetooth)
      - [3.2.3 Conexión del módulo del _buzzer_](#322-conexion-del-modulo-del-buzzer)
      - [3.2.4 Conexión del _DIP switch_](#324-conexion-del-dip-switch)
      - [3.2.5 Conexión de los _LEDs_](#325-conexion-de-los-leds)
    - [3.3 _Firmware_ de _BeepBuddy_](#33-firmware-de-beepbuddy)
      - [3.3.1 Organización modular del _firmware_](#331-organizacion-modular-del-firmware)
      - [3.3.2 Flujo de ejecución del _firmware_](#332-flujo-de-ejecucion-del-firmware)
    - [3.4 Diseño de la aplicación](#34-diseño-de-la-aplicacion)
  - [**Ensayos y resultados**](#ensayos-y-resultados)
    - [4.1 Pruebas funcionales del _hardware_](#41-pruebas_funcionales_del_hardware)
    - [4.2 Pruebas funcionales del _firmware_](#42-pruebas-funcionales-del-firmware)
    - [4.3 Pruebas de intrafración](#43-pruebas-de-integracion)
    - [4.4 Medición y análisis de consumo](#44-mediciones-y-analisis-de-consumo)
    ...
    - [4.7 Cálculo del factor de uso (U) de la _CPU_](#47-calculo-del-facotr-de-uso-(u)-de-la-cpu)
    - [4.8 Gestión de bajo consumo y justificación](#48-gestion-de-bajo-consumo-y-justificacion)
    - [4.9 Cumplimiento de requisiton](#49-cumplimiento-de-requisitos)
    - [4.10 Comparación con otros productos similares](#410-comparacion-con-otros-productors-similares)
    - [4.11 Documentación del desarrollo realizado](#411-documentacion-del-desarrollo-realizado)
  - [**Conclusiones**](#conclusiones)
    - [5.1 Resultados obtenidos](#51-resultados-obtenidos)
    - [5.2 Próximos pasos y posibles futuras mejoras](#52-proximos-pasos-y-posibles-futuras-mejoras)
...
<code>Lista_componentes_a_confirmar.txt</code></a>
</td></td>
</tr>
...
\[4\] Módulo _HM-10 Bluetooth 4.0 BLE a UART_. TodoMicro. [Online]. Available: https://www.todomicro.com.ar/comunicacion/637-modulo-hm-10-bluetooth-40-ble-a-uart.html?srsltid=AfmBOopp0r5laITQYUaryYYiX3FX0pVC3rmiN0xScYLpI9sgNRYFOCRr
