...
- [**Introducción específica**](#introducción-específica) 
  ...
  - [2.3 Descripción de los módulos del sistema](#23-descripción-de-los-módulos-del-sistema)
    ...
    - [2.3.3 Módulo del micrófono](#233-módulo-del-micrófono)
  ...
  - [**Diseño e implementación**](#diseño-e-implementación)
    ...
    - [3.2 Diseño del _hardware_](#32-diseño-del-hardware)
      - [3.2.1 Conexión del módulo del micrófono](#321-conexión-del-módulo-del-micrófono)
      - [3.2.2 Conexión del módulo _Bluetooth_](#322-conexión-del-módulo-bluetooth)
      - [3.2.3 Conexión del módulo del _buzzer_](#323-conexión-del-módulo-del-buzzer)
      - [3.2.4 Conexión del _DIP switch_](#324-conexión-del-dip-switch)
      - [3.2.5 Conexión de los _LEDs_](#325-conexión-de-los-leds)
    - [3.3 _Firmware_ de _BeepBuddy_](#33-firmware-de-beepbuddy)
      - [3.3.1 Organización modular del _firmware_](#331-organización-modular-del-firmware)
      - [3.3.2 Flujo de ejecución del _firmware_](#332-flujo-de-ejecución-del-firmware)
    - [3.4 Diseño de la aplicación](#34-diseño-de-la-aplicación)
